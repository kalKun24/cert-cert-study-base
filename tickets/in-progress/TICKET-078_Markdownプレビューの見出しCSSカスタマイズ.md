...
- [ ] Markdownプレビューの h1 にボトムボーダー（2px・グレー）が表示される
- [ ] Markdownプレビューの h2 にボトムボーダー（1px・グレー）が表示される
- [ ] h1・h2・h3 のフォントサイズ・ウェイトが適切に設定されている
- [ ] 既存のエディタ機能・他ページの表示に影響がない
- [ ] ダークモード（使用中の場合）でも視認性が保たれている

---

## サブチケット（コミット単位）

- [ ] `style(markdown): プレビュー見出し（h1〜h3）にGitHubスタイルのCSSを適用`
